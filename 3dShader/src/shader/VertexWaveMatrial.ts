export default class VertexWaveMatrial extends Laya.Material{
    ...
    public set width(value:number){
        this._shaderValues.setNumber(VertexWaveMatrial.WIDTH,value)
    }

    public set speed(value:number){
        this._shaderValues.setNumber(VertexWaveMatrial.SPEED,value)
    }
}